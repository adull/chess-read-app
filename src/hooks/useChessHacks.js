...
export const useChessHacks = () => {
  const handleAlmostPerfect = (setBoxes) => {
    const moves = [
      [
        "e4",
        "e5"
    ...
    toast.success("Almost Perfect Format loaded!", {
      position: "top-right",
      autoClose: 3000,
    });
  };

  const handleLogMoves = (boxes) => {
    ...
    toast.info("Moves logged to console!", {
      position: "top-right",
      autoClose: 3000,
    });
  };
