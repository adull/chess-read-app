import React, {
  ...
  const Box = ({
    ...
    // Local live position (smooth drag/resize)
    ...
    return (
      <div
        className={`absolute border-2 transition-all duration-150 ${
          isHovered ? "border-yellow-400" : "border-blue-500"
        } bg-blue-500/10`}
        style={{
          top: `${position.top}%`,
          left: `${position.left}%`,
      ...
      >
        ...
        >
          {isActive ? (
            ...
            <span className="text-xs text-white bg-blue-700 px-1 rounded">
              {box.text}
            </span>
          )}
